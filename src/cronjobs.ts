        ...
        try {
            ...
            for (const product of productsOnStore) {
                try {
                    ...
                    const existZip = await fs.access(`releases/${product._id}/${product.currentReleaseVersion}.zip`).then(() => true).catch(() => false);
                    if (!existZip) {
                    ...
                    const zipFile = new AdmZip(`releases/${product._id}/${product.currentReleaseVersion}.zip`);
