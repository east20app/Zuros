...
export const metadata: Metadata = { title: "Planos e preços · ZUROS APP", description: "Planos mensais para potencializar seus projetos e comunidades." };
