...
export const metadata: Metadata = {
    ...
    description: "Planos mensais para potencializar seus projetos e comunidades.",
    alternates: { canonical: "/planos" },
    openGraph: {
        title: "Planos e preços · ZUROS APP",
        description: "Planos mensais para potencializar seus projetos e comunidades.",
        type: "website",
        url: "/planos",
        images: [{ url: "/og.png", width: 1200, height: 630, alt: "ZUROS APP" }],
    },
    twitter: { card: "summary_large_image", title: "Planos e preços · ZUROS APP", description: "Planos mensais para potencializar seus projetos e comunidades.", images: ["/og.png"] },
};

export default async function PlansPage() {
    const user = await getSessionUser();
    const [catalogs, pendingCount] = await Promise.all([listStoreCatalogs(), user ? getUserPendingCount(user.discordId) : Promise.resolve(0)]);
