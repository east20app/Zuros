...
export function AppControls({ appId, status, online }: { appId: string; status: AppStatus; online: boolean }) {
        ...
        <>
            ...
            <Modal open={serverOpen} onClose={() => setServerOpen(false)} title="Servidor principal">
                ...
                >
                    ...
                    <p className="text-xs text-amber-300">
                        O pacote será atualizado na CamposCloud e a aplicação será reiniciada se estiver online.
                    </p>
                    <div className="flex justify-end gap-2">
            ...
            <Modal open={tokenOpen} onClose={() => setTokenOpen(false)} title="Alterar token do bot">
                <form
                    ...
                    onSubmit={async (e) => {
                        e.preventDefault();
                        if (await run("token", () => changeAppToken(appId, tokenValue))) setTokenOpen(false);
                    }}
                >
