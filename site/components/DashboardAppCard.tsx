    ...
    return (
        ...
        >
                ...
                <div className="flex min-w-0 items-start gap-3">
                    ...
                    <div className="min-w-0">
                        <div className="flex flex-wrap items-center gap-2">
                            <Link href={`/dashboard/${app.id}`} className="truncate font-display font-semibold text-white transition hover:text-magenta-300">
                                {app.name}
                            </Link>
                            <i
            ...
            <div className="mt-auto flex flex-wrap items-center gap-2">
                ...
                <Button size="sm" variant="primary" href={app.status === "active" ? `/dashboard/${app.id}/config` : "/dashboard/invoices"} className="ml-auto">
